...
<head>
	...
	<link rel="stylesheet" href="/cas/css/cas.min.css;jsessionid=41B4F6603340051910FDAE486DFD9055.jvm1" />
...
<form id="credential" action="/cas/login;jsessionid=41B4F6603340051910FDAE486DFD9055.jvm1?service=https://fenix.tecnico.ulisboa.pt/downloadFile/1689468335561276/Dates.java" method="post">
	<!-- Técnico ID -->
	...
	<!-- end fieldset Técnico ID -->
		...
		<fieldset data-selection="kerberos">
			...
			<input id="submit-kerberos" name="submit-kerberos" type="button" class="button button-active button-wide"
				...
				onClick="location.href='/cas/login?service=https://fenix.tecnico.ulisboa.pt/downloadFile/1689468335561276/Dates.java&auth=spnego'">
		</fieldset>
		<!-- end KERBEROS -->
		...
		<fieldset data-selection="cartaocidadao">
			...
			<input id="submit-ccidadao" name="submit-ccidadao" type="button" class="button button-active button-wide"
				...
				onClick="location.href='https://x509.id.tecnico.ulisboa.pt/cas/login?service=https://fenix.tecnico.ulisboa.pt/downloadFile/1689468335561276/Dates.java&auth=x509&language=pt'">
		</fieldset>
		<!-- end CARTÃO CIDADÃO -->
	...
	<input type="hidden" name="lt" value="LT-11467-3nXf4DLfdYwtLvLxUV5YWdKNXWbS0A-id.tecnico.ulisboa.pt" />
...
<script src="/cas/js/cas.min.js;jsessionid=41B4F6603340051910FDAE486DFD9055.jvm1"></script>
